...
ESTO ES EL ULTIMO REGISTRO ANTESD E HAEER LEL CAMIO ESTO FUE PORQUE TRATE DE ADATPATT OTODO CON BUTS TRAP  Y ADEMAD DE ESO
HICE QUE TODO SE AIDENTADO EL ERROR QUE TENIAMOS DES DE El primcipi era que en select no tenian id es por eso que nos alia errir ua que el jsons si lee name no toma el id pero la funcion tomaba el id por eso que app sdript no funcionaba del todo es por eso que la inf
informacion no llegaba al servidor por lo que no llegaba a gs 
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="card">
        ...
        <form action="" id="registrationForm">
            ...
            <div class="center1">
                ...
                <input type="text" class="form-control" id="docNumber" name="docNumber" placeholder="número de documento" required>
                <i class='bx bxs-user'></i>
            </div>
            ...
            <div class="center1"> 
                <input type="text" class="form-control" id="address" name="address" placeholder="Direccion" required>
            ...
            <div class="center1" id="phone">
                ...
                <input type="text" class="form-control" id="phone" name="phone" placeholder="Teléfono" pattern="[0-9]+" title="Please enter only digits" required>
                <i class='bx bxs-user'></i>
            </div>
            ...
            <div class="center1">
                <input type="text" class="form-control" id="accountCode" name="accountCode" placeholder="Codigo IBAN/Swift" required>
                <i class='bx bxs-user'></i>
            </div>
            <div>
                <input type="checkbox" class="form-control" id="terms" name="terms" required> Acepto los términos y condiciones <br>
            </div>
...
DOCUMENTOS JS ESTOS SON ULTIMSO ANTES DE HACER ELC AMBIO DE FIREBASE 
